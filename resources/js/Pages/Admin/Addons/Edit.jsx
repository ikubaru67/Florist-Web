...
export default function Edit({ addon }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        has_custom_message: addon.has_custom_message ?? false,
        image_urls: addon.images?.map(img => img.image_path) || [''],
    });
    ...
    const removeImageUrl = (index) => {
        ...
        setData('image_urls', newUrls.length > 0 ? newUrls : ['']);
    };
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 p-6 lg:p-8">
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-gray-500 mt-1">Update the main details about your add-on</p>
                            </div>
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 p-6 lg:p-8">
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-gray-500 mt-1">Update up to 5 images (URLs)</p>
                            </div>
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 p-6">
                            <div className="flex items-center justify-between gap-4">
                                ...
                                >
                                    ...
                                    <span>{processing ? 'Updating...' : 'Update Add-on'}</span>
                                </button>
                            </div>
                        </div>
                    </form>
